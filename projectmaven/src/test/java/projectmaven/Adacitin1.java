...
public class Adacitin1 extends BaseClass {
	...
	public void loginOperation() throws IOException, InterruptedException {
		...
		Assert.assertEquals("verify Book a hotel", "Book A Hotel", text3);
		...
		Assert.assertEquals("check booked utertity", "Booked Itinerary", text4);
